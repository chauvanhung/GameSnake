...
namespace AI_Snake.Snake
{
    ...
    class Food
    {
        ...
        {
            Render.Draw(g, new Point(coordinates.X * 10, coordinates.Y * 10), Brushes.MediumSeaGreen);
        }
        ...
        {
            Render.Draw(g, new Point(coordinates.X * 10, coordinates.Y * 10),  Brushes.White);
        }
